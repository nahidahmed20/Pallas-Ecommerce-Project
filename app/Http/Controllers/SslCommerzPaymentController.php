...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index($request, $customer)
    {
        ...
        # OPTIONAL PARAMETERS
        $post_data['value_a'] = $customer->first_name;
        $post_data['value_b'] = $customer->last_name;
    ...
    {
        Session::put('customer_id',$request->input('value_c'));
        ...
        if ($order_details->order_status == 'Pending') {
            ...
            if ($validation) {
                ...
                */
                ...
                return redirect('/complete-order')->with('message','Congratulation..your order info post successfully. Please wait we will contact with very soon..');
            }
            ...
            return back()->with('message','Invalid Transaction. Please contact with office admin');
        }
