                                    ...
                                    <div class="tab-pane show active" id="input-types-preview">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <form class="form-hoizontal" action="{{route('category.store')}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row mb-4">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea class="form-control" id="example-textarea" name="description" placeholder="Category Description" required></textarea>
                                                        </div>
                                                    </div>
