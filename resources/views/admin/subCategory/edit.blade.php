                                    ...
                                    <div class="tab-pane show active" id="input-types-preview">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                @endif
                                                <form class="form-hoizontal" action="{{route('sub-category.update', ['id'=> $sub_category->id])}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row mb-4">
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="name" value="{{$sub_category->name}}"  id="categoryName1" class="form-control" placeholder="Enter Sub Category Name">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea class="form-control" id="example-textarea" name="description" placeholder="Sub Category Description">{{$sub_category->description}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <img src="{{asset($sub_category->image)}}" alt="" height="60" width="50">
                                                        </div>
                                                    </div>
