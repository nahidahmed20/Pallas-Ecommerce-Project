                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Show Invoice</a></li>
                                </ol>
                            </div>
                        ...
                        <div class="card card-body">
                            <div class="invoice-box">
                                <table cellpadding="0" cellspacing="0">
                                        ...
                                        <td colspan="4">
                                            <table>
                                                <tr>
                                                    <td class="title">
                                                        <img
                                                            src="http://localhost/nahid-ecommerce/public/website/assets/img/logo/logo-2.png"
                                    ...
                                    <tr class="total">
                                        <td colspan="3"></td>
                                        <td>Total: {{$shipping = 100}}</td>
                                    </tr>
                                    <tr class="total">
                                        <td colspan="3"></td>
                                        <td>Total Payble: {{$sum+$tax+$shipping}}</td>
                                    </tr>
                                </table>
                                <hr/>
                                <tr>
